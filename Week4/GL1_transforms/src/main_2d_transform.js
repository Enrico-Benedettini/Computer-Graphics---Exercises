...
async function main() {
	...
	*/
	...
	const draw_triangle_with_transform = regl({
		...
		void main() {
			...
			gl_Position = vec4(position, 0, 1)*mat_transform;
		}`,
	...
	*/
	...
	const mat_transform2 = mat4.create()
	...
	regl.frame((frame) => {
		...
		*/
		...
		M_rotation.toString();
		let M_RT = mat4_matmul_many(mat_transform, M_rotation);
		M_RT.toString();


		draw_triangle_with_transform({
			mat_transform: M_rotation,
			color: color_red
		});
